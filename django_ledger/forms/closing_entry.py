from django.forms import (DateInput, HiddenInput, ModelForm, Textarea,
                          ValidationError)
...
class ClosingEntryCreateForm(ModelForm):
    ...
    def clean_closing_date(self):
        ...
        if closing_date > get_localdate():
            raise ValidationError(
                message=_("Cannot create a closing entry with a future date."),
                code="invalid_date",
            )
        return closing_date
    ...
    class Meta:
        ...
        labels = {"closing_date": _("Select a Closing Date")}
...
class ClosingEntryUpdateForm(ModelForm):
    class Meta:
        ...
        labels = {"markdown_notes": _("Closing Entry Notes")}
