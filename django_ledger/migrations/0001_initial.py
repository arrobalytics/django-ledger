# Generated by Django 2.2.7 on 2019-11-20 02:35

import django.core.validators
import django.db.models.deletion
import django_ledger.models.mixins.generic
import mptt.fields
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locked', models.BooleanField(default=False)),
                ('entity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='general_ledger', to='django_ledger.EntityModel')),
            ],
            options={
                'abstract': False,
            },
            bases=(models.Model, django_ledger.models.mixins.generic.IOMixIn),
        ),
        migrations.AddField(
