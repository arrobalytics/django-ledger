# Generated by Django 3.0.4 on 2020-03-24 01:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.URLField(blank=True, null=True, verbose_name='Website')),
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='Phone Number')),
                ('cash_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cash_account', to='django_ledger.AccountModel', verbose_name='Cash Account')),
                ('income_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='income_account', to='django_ledger.AccountModel', verbose_name='Income Account')),
                ...
                ('payable_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payable_account', to='django_ledger.AccountModel', verbose_name='Liability Account')),
                ('receivable_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receivable_account', to='django_ledger.AccountModel', verbose_name='Receivable Account')),
            ],
            options={
