    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ledgers', to='django_ledger.entitymodel', verbose_name='Ledger Entity')),
            ],
            options={
                'verbose_name': 'Ledger',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uom', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='django_ledger.unitofmeasuremodel', verbose_name='Unit of Measure')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_ledger.invoicemodel', verbose_name='Invoice Model')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount', models.DecimalField(decimal_places=2, editable=False, max_digits=20, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Total Amount QTY x UnitCost')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('bill_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_ledger.billmodel', verbose_name='Bill Model')),
                ('entity_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='django_ledger.entityunitmodel', verbose_name='Associated Entity Unit')),
                ('item_model', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='django_ledger.itemmodel', verbose_name='Item Model')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='billmodel',
            name='prepaid_account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bill_prepaid_account', to='django_ledger.accountmodel', verbose_name='Prepaid Account'),
        ),
        migrations.AddField(
            model_name='billmodel',
            name='unearned_account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bill_unearned_account', to='django_ledger.accountmodel', verbose_name='Unearned Account'),
        ),
        migrations.AddField(
            model_name='billmodel',
            name='vendor',
