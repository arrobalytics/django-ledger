    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.URLField(blank=True, null=True, verbose_name='Website')),
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='Phone Number')),
                ('cash_account', models.ForeignKey(limit_choices_to={'role': 'asset_ca_cash'}, on_delete=django.db.models.deletion.CASCADE, related_name='invoices_cash', to='django_ledger.AccountModel', verbose_name='Invoice Cash Account')),
                ('income_account', models.ForeignKey(limit_choices_to={'role__in': ['in_sales', 'in_pass', 'in_other']}, on_delete=django.db.models.deletion.CASCADE, related_name='invoices_in', to='django_ledger.AccountModel', verbose_name='Invoice Income Account')),
                ('ledger', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='django_ledger.LedgerModel', verbose_name='Invoice Ledger')),
                ('payable_account', models.ForeignKey(limit_choices_to={'role': 'lia_cl_acc_pay'}, on_delete=django.db.models.deletion.CASCADE, related_name='invoices_ap', to='django_ledger.AccountModel', verbose_name='Invoice Liability Account')),
                ('receivable_account', models.ForeignKey(limit_choices_to={'role': 'asset_ca_recv'}, on_delete=django.db.models.deletion.CASCADE, related_name='invoices_ar', to='django_ledger.AccountModel', verbose_name='Invoice Receivable Account')),
            ],
            options={
