    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('earnings_account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='invoice_earnings_account', to='django_ledger.accountmodel', verbose_name='Earnings Account')),
            ],
            options={
