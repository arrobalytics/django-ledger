...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='item_type',
            field=models.CharField(blank=True, choices=[('L', 'Labor'), ('M', 'Material'), ('E', 'Equipment'), ('S', 'Lump Sum'), ('O', 'Other')], max_length=1, null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.FloatField(blank=True, default=0.0, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Customer Estimate Revenue per Unit.'),
        ),
        ...
        migrations.AlterField(
            ...
            name='entity',
            field=models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='coa', to='django_ledger.entitymodel', verbose_name='Entity'),
        ),
        migrations.AlterField(
            model_name='chartofaccountmodel',
            name='slug',
            field=models.SlugField(editable=False, unique=True, validators=[django.core.validators.MinLengthValidator(limit_value=10, message='Slug field must contain at least 10 characters.')]),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='entity',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='django_ledger.entitymodel', verbose_name='Unit Entity'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='cash_account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='invoice_cash_account', to='django_ledger.accountmodel', verbose_name='Cash Account'),
        ),
        migrations.AlterField(
            model_name='invoicemodel',
            name='customer',
        ...
        migrations.AlterField(
            model_name='itemmodel',
            name='cogs_account',
            field=models.ForeignKey(blank=True, help_text='COGS account where cost will be recognized on Income Statement.', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='item_cogs_account', to='django_ledger.accountmodel', verbose_name='COGS Account'),
        ),
        migrations.AlterField(
            model_name='itemmodel',
            name='earnings_account',
            field=models.ForeignKey(blank=True, help_text='Earnings account where revenue will be recognized on Income Statement.', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='item_earnings_account', to='django_ledger.accountmodel', verbose_name='Earnings Account'),
        ),
        migrations.AlterField(
            model_name='itemmodel',
            name='expense_account',
            field=models.ForeignKey(blank=True, help_text='Expense account where cost will be recognized on Income Statement.', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='item_expense_account', to='django_ledger.accountmodel', verbose_name='Expense Account'),
        ),
        migrations.AlterField(
            model_name='itemmodel',
            name='inventory_account',
            field=models.ForeignKey(blank=True, help_text='Inventory account where cost will be capitalized.', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='item_inventory_account', to='django_ledger.accountmodel', verbose_name='Inventory Account'),
        ),
        migrations.AlterField(
            model_name='itemmodel',
            name='uom',
        ...
        migrations.AlterField(
            model_name='itemthroughmodel',
            name='bill_model',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='django_ledger.billmodel', verbose_name='Bill Model'),
        ),
        migrations.AlterField(
            model_name='itemthroughmodel',
            name='entity_unit',
        ...
        migrations.AlterField(
            model_name='itemthroughmodel',
            name='invoice_model',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='django_ledger.invoicemodel', verbose_name='Invoice Model'),
        ),
        migrations.AlterField(
            model_name='itemthroughmodel',
            name='po_model',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='django_ledger.purchaseordermodel', verbose_name='Purchase Order Model'),
        ),
        migrations.AlterField(
            model_name='itemthroughmodel',
            name='po_unit_cost',
            field=models.FloatField(blank=True, default=0.0, help_text='Purchase Order unit cost.', null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='PO Unit Cost'),
        ),
        migrations.AlterField(
            model_name='journalentrymodel',
            name='entity_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='django_ledger.entityunitmodel', verbose_name='Associated Entity Unit'),
        ),
        migrations.AlterField(
            model_name='ledgermodel',
            name='entity',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='django_ledger.entitymodel', verbose_name='Ledger Entity'),
        ),
        migrations.AlterField(
            model_name='transactionmodel',
            name='account',
            field=models.ForeignKey(help_text='Account from Chart of Accounts to be associated with this transaction.', on_delete=django.db.models.deletion.PROTECT, related_name='txs', to='django_ledger.accountmodel', verbose_name='Account'),
        ),
        migrations.AlterField(
            model_name='transactionmodel',
            name='journal_entry',
            field=models.ForeignKey(editable=False, help_text='Journal Entry to be associated with this transaction.', on_delete=django.db.models.deletion.PROTECT, related_name='txs', to='django_ledger.journalentrymodel', verbose_name='Journal Entry'),
        ),
        migrations.AddField(
            model_name='itemthroughmodel',
            name='ce_model',
        ...
        migrations.AddField(
            ...
            name='ce_model',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='django_ledger.customerestimatemodel', verbose_name='Associated Customer Job/Estimate'),
        ),
        migrations.AddIndex(
            model_name='customerestimatemodel',
