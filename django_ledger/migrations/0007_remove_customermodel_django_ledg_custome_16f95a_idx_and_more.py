    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                blank=True, null=True, verbose_name="Coa Role Default Account"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="customermodel",
            index=models.Index(
                fields=["entity_model", "customer_number"],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["entity_model", "vendor_number"],
                name="django_ledg_entity__266aa0_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="vendormodel",
            index=models.Index(
                fields=["vendor_number"], name="django_ledg_vendor__5f9f46_idx"
            ),
        ),
    ]
