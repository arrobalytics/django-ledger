...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["date_posted"], name="django_ledg_date_po_cbcc8c_idx"
                    ),
                    models.Index(
                        fields=["account_model"], name="django_ledg_account_53aea9_idx"
                    ),
                    models.Index(
                        fields=["transaction_model"],
                        name="django_ledg_transac_51a6b9_idx",
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["bank_account_model"], name="django_ledg_bank_ac_0bad20_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="importjobmodel",
            index=models.Index(
                fields=["ledger_model"], name="django_ledg_ledger__d9e03f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="importjobmodel",
            index=models.Index(
                fields=["completed"], name="django_ledg_complet_42632b_idx"
            ),
        ),
    ]
