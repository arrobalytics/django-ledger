# Generated by Django 4.2.2 on 2023-09-22 20:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('txs_model', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='django_ledger.transactionmodel')),
            ],
            options={
                'verbose_name': 'Staged Transaction Model',
                'abstract': False,
                'indexes': [models.Index(fields=['import_job'], name='django_ledg_import__8e6511_idx'), models.Index(fields=['date_posted'], name='django_ledg_date_po_cbcc8c_idx'), models.Index(fields=['account_model'], name='django_ledg_account_53aea9_idx'), models.Index(fields=['txs_model'], name='django_ledg_txs_mod_83f976_idx')],
            },
        ),
        migrations.AddIndex(
