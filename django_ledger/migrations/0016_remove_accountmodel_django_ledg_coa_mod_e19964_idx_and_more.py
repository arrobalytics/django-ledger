    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.SlugField(
                ...
                max_length=150,
                null=True,
                verbose_name="Ledger External ID",
            ),
        ),
        migrations.AddIndex(
            model_name="accountmodel",
            index=models.Index(
                fields=["coa_model", "code"], name="django_ledg_coa_mod_e073bc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="accountmodel",
        ...
        migrations.AddIndex(
            model_name="ledgermodel",
            index=models.Index(
                fields=["entity", "ledger_xid"], name="django_ledg_entity__7be095_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ledgermodel",
            index=models.Index(
                fields=["ledger_xid"], name="django_ledg_ledger__05f099_idx"
            ),
        ),
    ]
