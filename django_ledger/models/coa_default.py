CHART_OF_ACCOUNTS = [
    ...
    # INTANGIBLE ASSETS ------
    {'code': '1800', 'role': 'ia', 'balance_type': 'debit', 'name': 'INTANGIBLE ASSETS', 'parent': '1800'},
    ...
    {'code': '1910', 'role': 'aadj', 'balance_type': 'debit', 'name': 'Securities Unrealized Gains/Losses',
     'parent': '1900'},
    {'code': '1920', 'role': 'aadj', 'balance_type': 'debit', 'name': 'PPE Unrealized Gains/Losses', 'parent': '1900'},

    # ---------# ASSETS END #---------#

    # ---------# LIABILITIES START #---------#
    # CURRENT LIABILITIES ------
    {'code': '2000', 'role': 'cl', 'balance_type': 'credit', 'name': 'CURRENT LIABILITIES', 'parent': '2000'},
    {'code': '2010', 'role': 'cl', 'balance_type': 'credit', 'name': 'Current Liabilities', 'parent': '2000'},
    {'code': '2020', 'role': 'cl', 'balance_type': 'credit', 'name': 'Wages Payable', 'parent': '2000'},
    {'code': '2030', 'role': 'cl', 'balance_type': 'credit', 'name': 'Interest Payable', 'parent': '2000'},
    {'code': '2040', 'role': 'cl', 'balance_type': 'credit', 'name': 'Short-Term Payable', 'parent': '2000'},
    {'code': '2050', 'role': 'cl', 'balance_type': 'credit', 'name': 'Current Maturities LT Debt', 'parent': '2000'},
    {'code': '2060', 'role': 'cl', 'balance_type': 'credit', 'name': 'Deferred Revenues', 'parent': '2000'},
    {'code': '2070', 'role': 'cl', 'balance_type': 'credit', 'name': 'Other Payables', 'parent': '2000'},

    # LIABILITIES ACCOUNTS ------
    {'code': '2100', 'role': 'ltl', 'balance_type': 'credit', 'name': 'LONG TERM LIABILITIES', 'parent': '2100'},
    {'code': '2110', 'role': 'ltl', 'balance_type': 'credit', 'name': 'Long Term Notes Payable', 'parent': '2100'},
    {'code': '2120', 'role': 'ltl', 'balance_type': 'credit', 'name': 'Bonds Payable', 'parent': '2100'},
    {'code': '2130', 'role': 'ltl', 'balance_type': 'credit', 'name': 'Mortgage Payable', 'parent': '2100'},

    # ---------# LIABILITIES END #---------#

    # ---------# SHEREHOLDERS EQUITY START #---------#
    # CAPITAL ACCOUNTS ------
    {'code': '3000', 'role': 'cap', 'balance_type': 'credit', 'name': 'CAPITAL ACCOUNTS', 'parent': '3000'},
    {'code': '3010', 'role': 'cap', 'balance_type': 'credit', 'name': 'Capital Account 1', 'parent': '3000'},
    {'code': '3020', 'role': 'cap', 'balance_type': 'credit', 'name': 'Capital Account 2', 'parent': '3000'},
    {'code': '3030', 'role': 'cap', 'balance_type': 'credit', 'name': 'Capital Account 3', 'parent': '3000'},

    # CAPITAL ADJUSTMENTS
    {'code': '3910', 'role': 'cadj', 'balance_type': 'credit', 'name': 'Available for Sale', 'parent': '3000'},
    {'code': '3920', 'role': 'cadj', 'balance_type': 'credit', 'name': 'PPE Unrealized Gains/Losses', 'parent': '3000'},

    # REVENUE ACCOUNTS ------
    {'code': '4000', 'role': 'in', 'balance_type': 'credit', 'name': 'REVENUE ACCOUNTS', 'parent': '4000'},
    ...
    {'code': '4030', 'role': 'in', 'balance_type': 'credit', 'name': 'Property Sales Income', 'parent': '4000'},

    # COGS ACCOUNTS ------
    {'code': '5000', 'role': 'ex', 'balance_type': 'debit', 'name': 'COGS ACCOUNTS', 'parent': '5000'},
    {'code': '5010', 'role': 'ex', 'balance_type': 'debit', 'name': 'Cost of Goods Sold', 'parent': '5000'},
    ...
    {'code': '6060', 'role': 'ex', 'balance_type': 'debit', 'name': 'Commission Expense', 'parent': '6000'},
    {'code': '6070', 'role': 'ex', 'balance_type': 'debit', 'name': 'Depreciation Expense', 'parent': '6000'},
    {'code': '6080', 'role': 'ex', 'balance_type': 'debit', 'name': 'Employee Benefits', 'parent': '6000'},
    ...
    {'code': '6140', 'role': 'ex', 'balance_type': 'debit', 'name': 'Professional Fees', 'parent': '6000'},
    {'code': '6150', 'role': 'ex', 'balance_type': 'debit', 'name': 'License Expense', 'parent': '6000'},
    {'code': '6170', 'role': 'ex', 'balance_type': 'debit', 'name': 'Maintenance Expense', 'parent': '6000'},
    {'code': '6180', 'role': 'ex', 'balance_type': 'debit', 'name': 'Meals & Entertainment', 'parent': '6000'},
    ...
    {'code': '6250', 'role': 'ex', 'balance_type': 'debit', 'name': 'Maintenance & Repairs', 'parent': '6000'},
    ...
    {'code': '6300', 'role': 'ex', 'balance_type': 'debit', 'name': 'Property Management', 'parent': '6000'},
    {'code': '6400', 'role': 'ex', 'balance_type': 'debit', 'name': 'Vacancy', 'parent': '6000'},

    # MISC REVENUE ACCOUNTS ------
    {'code': '7000', 'role': 'in', 'balance_type': 'credit', 'name': 'MISC. REVENUE ACCOUNTS', 'parent': '7000'},
    {'code': '7010', 'role': 'in', 'balance_type': 'credit', 'name': 'Misc. Revenue', 'parent': '7000'},

    # MISC EXPENSE ACCOUNTS ------
    {'code': '7500', 'role': 'ex', 'balance_type': 'debit', 'name': 'MISC. EXPENSE ACCOUNTS', 'parent': '7500'},
