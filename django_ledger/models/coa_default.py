...
CHART_OF_ACCOUNTS = [
    ...
    {'code': '6060', 'role': roles.EXPENSE_REGULAR, 'balance_type': 'debit', 'name': 'Commission Expense',
     'parent': None},
    {'code': '6080', 'role': roles.EXPENSE_REGULAR, 'balance_type': 'debit', 'name': 'Employee Benefits',
     'parent': None},
    ...
    {'code': '6140', 'role': roles.EXPENSE_REGULAR, 'balance_type': 'debit', 'name': 'Professional Fees',
     'parent': None},
    {'code': '6150', 'role': roles.EXPENSE_REGULAR, 'balance_type': 'debit', 'name': 'License Expense', 'parent': None},
    {'code': '6170', 'role': roles.EXPENSE_REGULAR, 'balance_type': 'debit', 'name': 'Maintenance Expense',
     'parent': None},
    {'code': '6180', 'role': roles.EXPENSE_REGULAR, 'balance_type': 'debit', 'name': 'Meals & Entertainment',
     'parent': None},
    ...
    {'code': '6250', 'role': roles.EXPENSE_REGULAR, 'balance_type': 'debit', 'name': 'Maintenance & Repairs',
     'parent': None},
    ...
    {'code': '6300', 'role': roles.EXPENSE_REGULAR, 'balance_type': 'debit', 'name': 'Property Management',
     'parent': None},
...
CHART_OF_ACCOUNTS.sort(key=lambda x: (x['root_group'], x['role'], x['code']))
CHART_OF_ACCOUNTS_ROOT_MAP = {
    k: list(v) for k, v in groupby(CHART_OF_ACCOUNTS, key=lambda x: x['root_group'])
}
