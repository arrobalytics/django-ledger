...
SCHEMA_ROLE_ACCOUNT = {"type": "object"}

SCHEMA_ROLE_BALANCE = {"type": "object"}

SCHEMA_ROLE_BALANCE_BY_PERIOD = {"type": ["object", "null"]}

SCHEMA_GROUP_ACCOUNT = {"type": "object"}

SCHEMA_GROUP_BALANCE = {"type": "object"}

SCHEMA_GROUP_BALANCE_BY_PERIOD = {"type": ["object", "null"]}

SCHEMA_RATIOS = {"type": "object"}

SCHEMA_ACCOUNTS = {"type": "array"}
