...
class IncomeStatementReport(BaseReportSupport):
    def __init__(
        ...
        **kwargs,
        ...
        self.TABLE_HEADERS = {
            ...
            "name": {"title": "Account Name", "spacing": 50, "align": "C"},
            "balance_type": {"title": "Balance Type", "spacing": 5, "align": "C"},
            "balance": {
    ...
    def print_section_data(self, section_data):
        ...
        for acc in section_data:
            self.cell(w=self.TABLE_HEADERS["role"]["width"], h=account_height, txt="")
            self.cell(
            ...
            self.cell(
                w=self.TABLE_HEADERS["name"]["width"], h=account_height, txt=acc["name"]
            )
            self.cell(
    ...
    def print_operating_revenues(self):
        ...
        self.cell(w=20, h=2, txt="Net Operating Revenue")
    ...
    def print_operating_cogs(self):
        ...
        self.set_font(self.FONT_FAMILY, style="B", size=self.FONT_SIZE)
        self.cell(w=20, h=2, txt="Net COGS")
        self.set_font(self.FONT_FAMILY, style="B", size=self.FONT_SIZE + 1)
        self.set_x(180)
        self.cell(
            w=20,
            ...
            align="R",
            txt="{s}{tot}".format(
                s=currency_symbol(), tot=currency_format(-operating_section["net_cogs"])
            ),
        )
        self.ln(h=3)
        self.print_hline()
    ...
    def print_operating_gross_profit(self):
        ...
        self.cell(w=20, h=2, txt="Gross Profit (Op. Revenue - COGS)")
    ...
    def print_operating_expenses(self):
        ...
        self.set_font(self.FONT_FAMILY, style="B", size=self.FONT_SIZE)
        self.cell(w=20, h=2, txt="Net Operating Expense")
        self.set_font(self.FONT_FAMILY, style="B", size=self.FONT_SIZE + 1)
        self.set_x(180)
        self.cell(
            w=20,
    ...
    def print_net_operating_income(self):
        ...
        self.cell(
            ...
            h=2,
            align="R",
            txt="Net Operating Income (Loss): {s}{tot}".format(
                s=currency_symbol(),
                tot=currency_format(operating_section["net_operating_income"]),
            ),
        )
        self.ln(h=5)
    ...
    def print_other_revenues(self):
        ...
        self.set_font(self.FONT_FAMILY, style="B", size=self.FONT_SIZE)
        self.cell(w=20, h=2, txt="Net Other Revenue")
        self.set_font(self.FONT_FAMILY, style="B", size=self.FONT_SIZE + 1)
        self.set_x(180)
        self.cell(
            w=20,
    ...
    def print_other_expenses(self):
        ...
        self.set_font(self.FONT_FAMILY, style="B", size=self.FONT_SIZE)
        self.cell(w=20, h=2, txt="Net Other Expenses")
        self.set_font(self.FONT_FAMILY, style="B", size=self.FONT_SIZE + 1)
        self.set_x(180)
        self.cell(
            w=20,
    ...
    def print_net_other_income(self):
        ...
        self.cell(
            ...
            h=2,
            align="R",
            txt="Net Other Income (Loss): {s}{tot}".format(
                s=currency_symbol(),
                tot=currency_format(operating_section["net_other_income"]),
            ),
        )
        self.ln(h=10)
    ...
    def print_net_income(self):
        ...
        self.cell(
            ...
            h=2,
            align="R",
            txt="Net Income (Loss): {s}{tot}".format(
                s=currency_symbol(), tot=currency_format(ic_data["net_income"])
            ),
        )
        self.ln(h=5)
