...
from django_ledger.forms.unit import (EntityUnitModelCreateForm,
                                      EntityUnitModelUpdateForm)
...
class EntityUnitModelCreateView(EntityUnitModelModelBaseView, CreateView):
    ...
    def form_valid(self, form):
        ...
        entity_model = get_object_or_404(
            entity_model_qs, slug__exact=self.kwargs["entity_slug"]
        )
...
class QuarterlyEntityUnitModelBalanceSheetView(
    FiscalYearEntityUnitModelBalanceSheetView, QuarterlyReportMixIn
):
    """
...
class MonthlyEntityUnitModelBalanceSheetView(
    FiscalYearEntityUnitModelBalanceSheetView, MonthlyReportMixIn
):
    """
...
class DateEntityUnitModelBalanceSheetView(
    MonthlyEntityUnitModelBalanceSheetView, DateReportMixIn
):
    """
...
class BaseEntityUnitModelIncomeStatementView(
    EntityUnitModelModelBaseView, RedirectView
):
    def get_redirect_url(self, *args, **kwargs):
        year = get_localdate().year
        return reverse(
            "django_ledger:unit-ic-year",
            kwargs={
                "entity_slug": self.kwargs["entity_slug"],
                "unit_slug": self.kwargs["unit_slug"],
                "year": year,
...
class QuarterlyEntityUnitModelCashFlowStatementView(
    FiscalYearEntityUnitModelCashFlowStatementView, QuarterlyReportMixIn
):
    """
...
class MonthlyEntityUnitModelCashFlowStatementView(
    FiscalYearEntityUnitModelCashFlowStatementView, MonthlyReportMixIn
):
    """
...
class DateEntityUnitModelCashFlowStatementView(
    FiscalYearEntityUnitModelCashFlowStatementView, DateReportMixIn
):
    """
