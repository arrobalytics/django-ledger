...
from django_ledger.forms.purchase_order import PurchaseOrderModelCreateForm
...
class PurchaseOrderModelDetailView(LoginRequiredMixIn, DetailView):
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        ...
        po_model: PurchaseOrderModel = self.object
        # bill_items_qs, item_data = po_model.get_po_item_data(
        #     queryset=po_model.billmodelitemsthroughmodel_set.all()
        # )
