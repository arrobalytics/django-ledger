...
from django_ledger.forms.bank_account import (BankAccountCreateForm,
...
class BaseBankAccountModelActionView(
    BankAccountModelModelBaseView, RedirectView, SingleObjectMixin
):
    ...
    def get_redirect_url(self, *args, **kwargs):
        return reverse(
            "django_ledger:bank-account-list",
            kwargs={"entity_slug": kwargs["entity_slug"]},
        )
    ...
    def get(self, request, *args, **kwargs):
        ...
        response = super(BaseBankAccountModelActionView, self).get(
            request, *args, **kwargs
        )
