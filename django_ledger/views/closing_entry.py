...
from django_ledger.forms.closing_entry import (ClosingEntryCreateForm,
                                               ClosingEntryUpdateForm)
from django_ledger.io.io_core import get_localdate
from django_ledger.models import ClosingEntryModelQuerySet, EstimateModel
...
class ClosingEntryModelBaseView(DjangoLedgerSecurityMixIn):
    ...
    def get_queryset(self):
        if self.queryset is None:
            ...
            closing_entry_model_qs = (
                entity_model.closingentrymodel_set.all()
...
class ClosingEntryModelCreateView(ClosingEntryModelBaseView, CreateView):
    ...
    def form_valid(self, form):
        ...
        ce_model, _ = entity_model.close_entity_books(
            closing_date=closing_date, force_update=True, post_closing_entry=False
        )
...
class ClosingEntryModelDetailView(ClosingEntryModelBaseView, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        closing_entry_txs_qs = (
            closing_entry_model.closingentrytransactionmodel_set.all()
        )
...
class ClosingEntryDeleteView(ClosingEntryModelBaseView, DeleteView):
    ...
    def get_context_data(self, **kwargs):
        ...
        entity_model: EntityModel = self.get_authorized_entity_instance()
        context["page_title"] = "Delete Closing Entry {}".format(
            closing_entry_model.closing_date
        )
...
class ClosingEntryModelActionView(
    ClosingEntryModelBaseView, RedirectView, SingleObjectMixin
):
    ...
    def get_redirect_url(self, *args, **kwargs):
        return reverse(
            "django_ledger:closing-entry-detail",
            kwargs={
    ...
    def get(self, request, *args, **kwargs):
        ...
        response = super(ClosingEntryModelActionView, self).get(
            request, *args, **kwargs
        )
