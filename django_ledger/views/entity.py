...
# Entity CRUD Views ----
class EntityModelListView(
    DjangoLedgerSecurityMixIn, EntityModelModelViewQuerySetMixIn, ListView
):
    template_name = "django_ledger/entity/entitiy_list.html"
    context_object_name = "entities"
    PAGE_TITLE = _("My Entities")
    extra_context = {"header_title": PAGE_TITLE, "page_title": PAGE_TITLE}


class EntityModelCreateView(
    DjangoLedgerSecurityMixIn, EntityModelModelViewQuerySetMixIn, CreateView
):
    ...
    def form_valid(self, form):
        ...
        if default_coa:
            entity_model.populate_default_coa(
                activate_accounts=activate_accounts, coa_model=default_coa_model
            )
...
class EntityModelUpdateView(
    DjangoLedgerSecurityMixIn, EntityModelModelViewQuerySetMixIn, UpdateView
):
...
class EntityDeleteView(
    DjangoLedgerSecurityMixIn, EntityModelModelViewQuerySetMixIn, DeleteView
):
    slug_url_kwarg = "entity_slug"
    context_object_name = "entity"
...
class EntityModelDetailHandlerView(
    DjangoLedgerSecurityMixIn, EntityUnitMixIn, RedirectView
):
    def get_redirect_url(self, *args, **kwargs):
        ...
        if unit_slug:
            return reverse(
                "django_ledger:unit-dashboard-month",
                kwargs={
        ...
        return reverse(
            "django_ledger:entity-dashboard-year",
            kwargs={"entity_slug": self.kwargs["entity_slug"], "year": loc_date.year},
        )


class EntityModelDetailBaseView(
    DjangoLedgerSecurityMixIn,
