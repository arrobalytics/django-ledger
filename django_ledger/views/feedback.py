...
from django_ledger.settings import (DJANGO_LEDGER_FEEDBACK_EMAIL_LIST,
                                    DJANGO_LEDGER_FEEDBACK_FROM_EMAIL)
from django_ledger.views.mixins import (DjangoLedgerSecurityMixIn,
                                        SuccessUrlNextMixIn)


class BugReportView(DjangoLedgerSecurityMixIn, SuccessUrlNextMixIn, FormView):
    ...
    def form_valid(self, form):
        ...
        message = (
            f'How to reproduce?: {form_data["reproduce"]}\n'
...
class RequestNewFeatureView(DjangoLedgerSecurityMixIn, SuccessUrlNextMixIn, FormView):
    http_method_names = ["post"]
    ...
    def form_valid(self, form):
        form_data = form.cleaned_data
        message = (
            f'Description: {form_data["feature_description"]}\n'
