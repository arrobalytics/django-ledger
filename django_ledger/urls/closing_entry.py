...
urlpatterns = [
    ...
    path(
        "<slug:entity_slug>/list/year/<int:year>/",
        views.ClosingEntryModelYearListView.as_view(),
        name="closing-entry-list-year",
    ),
    path(
        "<slug:entity_slug>/list/month/<int:year>/<int:month>/",
    ...
    path(
        "<slug:entity_slug>/detail/<uuid:closing_entry_pk>/",
        views.ClosingEntryModelDetailView.as_view(),
        name="closing-entry-detail",
    ),
    path(
        "<slug:entity_slug>/update/<uuid:closing_entry_pk>/",
        views.ClosingEntryModelUpdateView.as_view(),
        name="closing-entry-update",
    ),
    path(
        "<slug:entity_slug>/delete/<uuid:closing_entry_pk>/",
        views.ClosingEntryDeleteView.as_view(),
        name="closing-entry-delete",
    ),
    # ACTIONS...
    path(
        "<slug:entity_slug>/action/<uuid:closing_entry_pk>/post/",
        views.ClosingEntryModelActionView.as_view(action_name="mark_as_posted"),
        name="closing-entry-action-mark-as-posted",
    ),
    path(
        "<slug:entity_slug>/action/<uuid:closing_entry_pk>/unpost/",
        views.ClosingEntryModelActionView.as_view(action_name="mark_as_unposted"),
        name="closing-entry-action-mark-as-unposted",
    ),
    path(
        "<slug:entity_slug>/action/<uuid:closing_entry_pk>/update-txs/",
