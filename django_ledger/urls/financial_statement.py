...
urlpatterns = [
    ...
    path('entity/<slug:entity_slug>/balance-sheet/year/<int:year>/pdf/',
         views.FiscalYearEntityModelBalanceSheetView.as_view(pdf=True),
    ...
    path('entity/<slug:entity_slug>/income-statement/year/<int:year>/pdf/',
         views.FiscalYearEntityModelIncomeStatementView.as_view(pdf=True),
    ...
    path('entity/<slug:entity_slug>/cash-flow-statement/year/<int:year>/pdf/',
         views.FiscalYearEntityModelCashFlowStatementView.as_view(pdf=True),
